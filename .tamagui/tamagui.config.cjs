...
var require_cjs = __commonJS({
  "node_modules/@tamagui/font-inter/dist/cjs/index.js"(exports, module2) {
    ...
    var createInterFont2 = /* @__PURE__ */ __name((font = {}, {
      ...
      return (0, import_core49.createFont)({
        family: import_core49.isWeb ? 'Inter, -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif' : "Inter",
        lineHeight: Object.fromEntries(
          Object.entries(size3).map(([k, v]) => [k, sizeLineHeight((0, import_core49.getVariableValue)(v))])
        ),
        weight: {
          4: "300"
        },
...
var require_cjs2 = __commonJS({
  "node_modules/@tamagui/font-silkscreen/dist/cjs/index.js"(exports, module2) {
    ...
    var createSilkscreenFont2 = /* @__PURE__ */ __name((font = {}) => {
      return (0, import_core49.createFont)({
        family: import_core49.isWeb ? "Silkscreen, Fira Code, Monaco, Consolas, Ubuntu Mono, monospace" : "Silkscreen",
        size: size3,
        lineHeight: Object.fromEntries(
...
var require_PresenceContext = __commonJS({
  "node_modules/@tamagui/use-presence/dist/cjs/PresenceContext.js"(exports, module2) {
    ...
    var PresenceContext2 = (0, import_react38.createContext)(null);
  }
});
...
var require_usePresence = __commonJS({
  "node_modules/@tamagui/use-presence/dist/cjs/usePresence.js"(exports, module2) {
    ...
    function usePresence2() {
      const context = (0, import_react38.useContext)(import_PresenceContext2.PresenceContext);
      if (!context) {
        return [true, null, context];
      }
      const { isPresent: isPresent22, onExitComplete, register } = context;
      const id = (0, import_react38.useId)() || "";
      (0, import_react38.useEffect)(() => register(id), [id, register]);
    ...
    function useIsPresent2() {
      return isPresent2((0, import_react38.useContext)(import_PresenceContext2.PresenceContext));
    }
    ...
    function createAnimations2(animations2) {
      ...
      return {
        ...
        useAnimations: ({ props, onDidAnimate, style, state, presence }) => {
          ...
          const res = (0, import_react38.useMemo)(() => {
            var _a;
            const runners = [];
            const completions = [];
              ...
              if (value) {
                ...
                runners.push(() => {
                  ...
                  function getAnimation() {
                    return import_react_native12.Animated[animationConfig.type || "spring"](value, {
                      toValue: val,
                      useNativeDriver: !import_web17.isWeb,
                      ...animationConfig
                    });
                  ...
                  const animation = animationConfig.delay ? import_react_native12.Animated.sequence([
                    import_react_native12.Animated.delay(animationConfig.delay),
                    getAnimation()
                  ]) : getAnimation();
...
var require_useGet = __commonJS({
  "node_modules/@tamagui/use-event/dist/cjs/useGet.js"(exports, module2) {
    ...
    var useIsomorphicLayoutEffect14 = !isWeb28 || isClient6 ? import_react38.useLayoutEffect : import_react38.useEffect;
    function useGet6(currentValue, initialValue2, forwardToFunction) {
      const curRef = (0, import_react38.useRef)(initialValue2 ?? currentValue);
...
var require_cjs10 = __commonJS({
  "node_modules/@tamagui/get-size/dist/cjs/index.js"(exports, module2) {
    ...
    var stepTokenUpOrDown6 = /* @__PURE__ */ __name((type, name = "$true", shift2 = 0, bounds = [0]) => {
      const tokens2 = (0, import_core49.getTokens)({ prefixed: true })[type];
      const maybeTokenizedKeysOrdered = import_core49.tokensKeysOrdered.get(tokens2) || Object.keys(tokens2);
...
var require_cjs11 = __commonJS({
  "node_modules/@tamagui/get-button-sized/dist/cjs/index.js"(exports, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports);
    var import_get_size11 = require_cjs10();
...
var require_cjs12 = __commonJS({
  "node_modules/@tamagui/get-font-sized/dist/cjs/index.js"(exports, module2) {
    ...
    var getFontSized4 = /* @__PURE__ */ __name((sizeTokenIn = "$true", { fonts, props }) => {
      var _a, _b, _c;
      const family = (0, import_core49.getVariableValue)(props.fontFamily) || "$body";
    ...
    function getDefaultSizeToken(font) {
      ...
      const sizeTokens = "$true" in font.size ? font.size : (0, import_core49.getTokens)().size;
...
var require_Image = __commonJS({
  "node_modules/@tamagui/image/dist/cjs/Image.js"(exports, module2) {
    ...
    var StyledImage = (0, import_core49.styled)(import_react_native12.Image, {
      name: "Image",
      position: "relative",
      source: { uri: "" },
      zIndex: 1
    ...
    var Image2 = StyledImage.extractable(
      (0, import_react38.forwardRef)((inProps, ref) => {
        const props = (0, import_core49.useMediaPropsActive)(inProps);
        ...
        const finalSource = typeof src === "string" ? { uri: src, ...import_core49.isWeb && { width: props.width, height: props.height } } : source ?? src;
        return /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(StyledImage, { ref, source: finalSource, ...rest });
      })
    );
    Image2.getSize = import_react_native12.Image.getSize;
    Image2.getSizeWithHeaders = import_react_native12.Image.getSizeWithHeaders;
    Image2.prefetch = import_react_native12.Image.prefetch;
    Image2.prefetchWithMetadata = import_react_native12.Image.prefetchWithMetadata;
    Image2.abortPrefetch = import_react_native12.Image.abortPrefetch;
    Image2.queryCache = import_react_native12.Image.queryCache;
  }
});
...
var require_getFontSize = __commonJS({
  "node_modules/@tamagui/font-size/dist/cjs/getFontSize.js"(exports, module2) {
    ...
    var getFontSize4 = /* @__PURE__ */ __name((inSize, opts) => {
      ...
      if ((0, import_core49.isVariable)(res)) {
        return +res.val;
      }
      return res ? +res : 16;
    }, "getFontSize");
    var getFontSizeVariable = /* @__PURE__ */ __name((inSize, opts) => {
      ...
      const conf = (0, import_core49.getConfig)();
...
var require_getSpace = __commonJS({
  "node_modules/@tamagui/helpers-tamagui/dist/cjs/getSpace.js"(exports, module2) {
    ...
    var getSpace = /* @__PURE__ */ __name((token, sizeUpOrDownBy = 0) => {
      const spaces2 = (0, import_core49.getTokens)().space;
...
var require_useCurrentColor = __commonJS({
  "node_modules/@tamagui/helpers-tamagui/dist/cjs/useCurrentColor.js"(exports, module2) {
    ...
    var useCurrentColor = /* @__PURE__ */ __name((colorProp) => {
      ...
      return (0, import_core49.variableToString)(theme[colorProp] || colorProp || theme.color);
    }, "useCurrentColor");
  }
});
  ...
  "node_modules/@tamagui/helpers-tamagui/dist/cjs/useGetThemedIcon.js"(exports, module2) {
    ...
    var useGetThemedIcon4 = /* @__PURE__ */ __name((props) => {
      ...
      return (el) => {
        if (!el)
          return el;
        if ((0, import_react38.isValidElement)(el)) {
          return (0, import_react38.cloneElement)(el, {
            ...props,
            // @ts-expect-error
            ...el.props
          });
        }
        return (0, import_react38.createElement)(el, props);
      };
    }, "useGetThemedIcon");
  }
});
  ...
  "node_modules/@tamagui/focusable/dist/cjs/focusableInputHOC.js"(exports, module2) {
    ...
    function focusableInputHOC3(Component) {
      const component = Component.extractable(
        (0, import_react38.forwardRef)(
          (props, ref) => {
            const isInput = (0, import_web17.isTamaguiComponent)(Component) && Component.staticConfig.isInput;
            const inputValue = (0, import_react38.useRef)(props.value || props.defaultValue || "");
            const unregisterFocusable = (0, import_react38.useRef)();
            const inputRef = (0, import_react38.useCallback)(
              (input) => {
                var _a;
                if (!props.id)
                  return;
            ...
            const onChangeText = (0, import_web17.useEvent)((value) => {
              var _a;
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(Component, { ref: combinedRefs, ...finalProps });
          }
        )
      );
      return component;
...
var require_getElevation = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/getElevation.js"(exports, module2) {
    ...
    var getElevation2 = /* @__PURE__ */ __name((size3, extras) => {
      ...
      const sizeNum = (0, import_core49.isVariable)(token) ? +token.val : size3;
      return getSizedElevation2(sizeNum, extras);
    }, "getElevation");
    var getSizedElevation2 = /* @__PURE__ */ __name((val, { theme, tokens: tokens2 }) => {
      let num = 0;
      if (val === true) {
        const val2 = (0, import_core49.getVariableValue)(tokens2.size["true"]);
...
var require_Stacks = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/Stacks.js"(exports, module2) {
    ...
    var YStack2 = (0, import_core49.styled)(import_core49.Stack, {
      flexDirection: "column",
      name: "YStack",
      variants: variants2
    });
    var XStack2 = (0, import_core49.styled)(import_core49.Stack, {
      flexDirection: "row",
      name: "XStack",
      variants: variants2
    });
    var ZStack2 = (0, import_core49.styled)(
      YStack2,
      {
        name: "ZStack",
        position: "relative"
...
var require_SizableStack = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/SizableStack.js"(exports, module2) {
    ...
    var SizableStack2 = (0, import_core49.styled)(import_Stacks3.XStack, {
      name: "SizableStack",
      variants: {
        unstyled: {
          true: {
...
var require_ThemeableStack = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/ThemeableStack.js"(exports, module2) {
    ...
    var ThemeableStack2 = (0, import_core49.styled)(import_Stacks3.YStack, {
      name: "SizableStack",
      variants: {
        backgrounded: {
          true: {
...
var require_useControllableState = __commonJS({
  "node_modules/@tamagui/use-controllable-state/dist/cjs/useControllableState.js"(exports, module2) {
    ...
    function useControllableState2({
      ...
      const [state, setState] = (0, import_react38.useState)(prop ?? defaultProp);
      const previous = (0, import_react38.useRef)(state);
      ...
      const transitionFn = transition ? import_react38.startTransition : emptyCallbackFn2;
      (0, import_react38.useEffect)(() => {
        if (prop === void 0)
          return;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useState28 = React39.useState, useEffect30 = React39.useEffect, useLayoutEffect5 = React39.useLayoutEffect, useDebugValue2 = React39.useDebugValue;
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useRef27 = React39.useRef, useEffect30 = React39.useEffect, useMemo15 = React39.useMemo, useDebugValue2 = React39.useDebugValue;
...
var require_Group = __commonJS({
  "node_modules/@tamagui/group/dist/cjs/Group.js"(exports, module2) {
    ...
    var import_jsx_runtime45 = require("react/jsx-runtime");
    var import_core49 = require("@tamagui/core-node");
    var import_create_context20 = require_cjs19();
    var import_stacks26 = require_cjs20();
    var import_use_controllable_state14 = require_cjs21();
    var import_react38 = __toESM2(require("react"));
    var import_react_native12 = require("react-native-web-lite");
    ...
    var GroupFrame = (0, import_core49.styled)(import_stacks26.ThemeableStack, {
      name: "GroupFrame",
      variants: {
        unstyled: {
          false: {
    ...
    function createGroup(verticalDefault) {
      return (0, import_core49.withStaticProperties)(
        (0, import_react38.forwardRef)((props, ref) => {
          const activeProps = (0, import_core49.useMediaPropsActive)(props);
          const {
            __scopeGroup,
            ...
            forceUseItem,
            ...restProps
          } = (0, import_core49.getExpandedShorthands)(activeProps);
          const vertical = orientation === "vertical";
          const [itemChildrenCount, setItemChildrenCount] = (0, import_use_controllable_state14.useControllableState)({
            defaultProp: forceUseItem ? 1 : 0
          });
          const isUsingItems = true;
          const radius2 = borderRadius ?? (size3 ? (0, import_core49.getVariableValue)((0, import_core49.getTokens)().radius[size3]) - 1 : void 0);
          const hasRadius = radius2 !== void 0;
          const disablePassBorderRadius = disablePassBorderRadiusProp ?? !hasRadius;
          if (!isUsingItems)
            console.log("screw up!");
          const childrenArray = import_react38.Children.toArray(childrenProp);
          ...
          const onItemMount = import_react38.default.useCallback(
            () => setItemChildrenCount((prev) => prev + 1),
            []
          );
          const onItemUnmount = import_react38.default.useCallback(
            () => setItemChildrenCount((prev) => prev - 1),
            []
          );
    ...
    var GroupItem = /* @__PURE__ */ __name((props) => {
      ...
      const groupItemProps = useGroupItem3(
        { disabled: (0, import_react38.isValidElement)(children) ? children.props.disabled : void 0 },
        __scopeGroup
      );
      if (!(0, import_react38.isValidElement)(children)) {
        return children;
      }
      if ((0, import_core49.isTamaguiElement)(children)) {
        return import_react38.default.cloneElement(children, groupItemProps);
      }
      return import_react38.default.cloneElement(children, {
        style: {
    ...
    var cloneElementWithPropOrder = /* @__PURE__ */ __name((child, props) => {
      const next = (0, import_core49.mergeProps)(child.props, props, false, (0, import_core49.getConfig)().shorthands)[0];
      return import_react38.default.cloneElement({ ...child, props: null }, next);
...
var require_wrapChildrenInText = __commonJS({
  "node_modules/@tamagui/text/dist/cjs/wrapChildrenInText.js"(exports, module2) {
    ...
    function wrapChildrenInText2(TextComponent, propsIn, extraProps) {
      ...
      const allChildren = import_react38.default.Children.toArray(children);
      const nextChildren = [];
      ...
      function concatStringChildren() {
        ...
        nextChildren[index3] = /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(TextComponent, { ...props, ...textProps, children: childrenStrings }, index3);
      }
...
var require_ListItem = __commonJS({
  "node_modules/@tamagui/list-item/dist/cjs/ListItem.js"(exports, module2) {
    ...
    var import_helpers_tamagui4 = require_cjs17();
    var import_stacks26 = require_cjs20();
    var import_text7 = require_cjs23();
    var import_react38 = require("react");
    var NAME3 = "ListItem";
    var ListItemFrame = (0, import_core49.styled)(import_stacks26.ThemeableStack, {
      name: NAME3,
      tag: "li",
      variants: {
        unstyled: {
        ...
        size: {
          "...size": (val, { tokens: tokens2 }) => {
            return {
              ...
              paddingVertical: (0, import_helpers_tamagui4.getSpace)(val, -2)
            };
          }
        },
        active: {
    ...
    var ListItemText = (0, import_core49.styled)(import_text7.SizableText, {
      name: "ListItemText",
      variants: {
        unstyled: {
          false: {
    ...
    var ListItemSubtitle = (0, import_core49.styled)(ListItemText, {
    ...
    var ListItemTitle = (0, import_core49.styled)(ListItemText, {
      name: "ListItemTitle"
    });
    var useListItem = /* @__PURE__ */ __name((props, {
      ...
      const mediaActiveProps = (0, import_core49.useMediaPropsActive)(props);
      ...
      const spaceSize = (0, import_core49.getVariableValue)((0, import_core49.getTokens)().space[mediaActiveProps.space] ?? iconSize) * scaleSpace;
      ...
      return {
        props: {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [
            themedIcon ? /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [
              themedIcon,
              /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(import_core49.Spacer, { size: spaceSize })
            ] }) : null,
            title || subTitle ? /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)(import_stacks26.YStack, { flex: 1, children: [
              noTextWrap === "all" ? title : /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(Title, { size: size3, children: title }),
              subTitle ? /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(import_jsx_runtime45.Fragment, { children: typeof subTitle === "string" && noTextWrap !== "all" ? (
                // TODO can use theme but we need to standardize to alt themes
                // or standardize on subtle colors in themes
                /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(Subtitle, { size: subtitleSize, children: subTitle })
              ) : subTitle }) : null,
              contents
            ] }) : contents,
            themedIconAfter ? /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(import_core49.Spacer, { size: spaceSize }),
              themedIconAfter
            ] }) : null
          ] })
    ...
    var ListItemComponent = (0, import_react38.forwardRef)((props, ref) => {
      const { props: listItemProps } = useListItem(props);
      return /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(ListItemFrame, { ref, justifyContent: "space-between", ...listItemProps });
    });
    ...
    var ListItem2 = (0, import_core49.withStaticProperties)(
      ListItemFrame.extractable(
        (0, import_core49.themeable)(ListItemComponent, { componentName: NAME3 }),
...
var require_cjs25 = __commonJS({
  "node_modules/@tamagui/constants/dist/cjs/index.js"(exports, module2) {
    ...
    var isClient6 = isWeb28 && isWindowDefined2;
    var isRSC4 = process.env.ENABLE_RSC;
    var idFn5 = /* @__PURE__ */ __name(() => {
    }, "idFn");
    var useIsomorphicLayoutEffect14 = isRSC4 ? idFn5 : isServer3 ? import_react38.useEffect : import_react38.useLayoutEffect;
    var isChrome3 = typeof navigator !== "undefined" && /Chrome/.test(navigator.userAgent || "");
    var isWebTouchable3 = isClient6 && ("ontouchstart" in window || navigator.maxTouchPoints > 0);
    var isTouchable4 = !isWeb28 || isWebTouchable3;
    if (process.env.NODE_ENV === "development") {
      if (!process.env.TAMAGUI_TARGET) {
        console.warn(`Must set TAMAGUI_TARGET to "web" or "native"`);
      } else if (isClient6 && process.env.TAMAGUI_TARGET !== "web" && process.env.TAMAGUI_IGNORE_TARGET !== "1") {
        console.warn(
...
var require_addTheme = __commonJS({
  "node_modules/@tamagui/theme/dist/cjs/addTheme.js"(exports, module2) {
    ...
    var import_constants10 = require_cjs25();
    var import_web17 = require("@tamagui/core-node");
...
var require_updateTheme = __commonJS({
  "node_modules/@tamagui/theme/dist/cjs/updateTheme.js"(exports, module2) {
    ...
    var import_web17 = require("@tamagui/core-node");
    var import_addTheme = require_addTheme();
...
// node_modules/@tamagui/config/node_modules/@tamagui/create-theme/dist/esm/index.js
...
// node_modules/@tamagui/config/node_modules/@tamagui/themes/dist/esm/tokens.js
...
// node_modules/@tamagui/config/node_modules/@tamagui/themes/dist/esm/themes.js
...
__export(esm_exports2, {
  ...
  AnimationDriverProvider: () => import_core48.AnimationDriverProvider,
  Article: () => Article,
  Aside: () => Aside,
  Avatar: () => Avatar,
  ...
  Fieldset: () => Fieldset,
  FontLanguage: () => import_core48.FontLanguage,
  Footer: () => Footer,
  Form: () => Form,
  FormFrame: () => FormFrame,
  ...
  Spacer: () => import_core48.Spacer,
  Spinner: () => Spinner,
  Square: () => Square,
  Stack: () => import_core48.Stack,
  Switch: () => Switch,
  ...
  Text: () => import_core48.Text,
  TextAncestorContext: () => import_core48.TextAncestorContext,
  TextArea: () => TextArea,
  TextAreaFrame: () => TextAreaFrame,
  Theme: () => import_core48.Theme,
  ...
  Track: () => Track,
  Unspaced: () => import_core48.Unspaced,
  ...
  createComponent: () => import_core48.createComponent,
  createContext: () => createContext3,
  createContextScope: () => createContextScope,
  createDialogScope: () => createDialogScope,
  createFont: () => import_core48.createFont,
  ...
  createShorthands: () => import_core48.createShorthands,
  createSwitchScope: () => createSwitchScope,
  createTamagui: () => createTamagui,
  createTheme: () => import_core48.createTheme,
  createToggleGroupScope: () => createToggleGroupScope,
  createTokens: () => import_core48.createTokens,
  createVariable: () => import_core48.createVariable,
  debounce: () => debounce,
  defaultStyles: () => defaultStyles,
  fullscreenStyle: () => fullscreenStyle,
  getAnimationDriver: () => import_core48.getAnimationDriver,
  getConfig: () => import_core48.getConfig,
  getMedia: () => import_core48.getMedia,
  getShapeSize: () => getShapeSize,
  getState: () => getState2,
  getStylesAtomic: () => import_core48.getStylesAtomic,
  getThemes: () => import_core48.getThemes,
  getTokens: () => import_core48.getTokens,
  getVariable: () => import_core48.getVariable,
  getVariableName: () => import_core48.getVariableName,
  getVariableValue: () => import_core48.getVariableValue,
  idFn: () => idFn,
  insertFont: () => import_core48.insertFont,
  isChrome: () => import_core48.isChrome,
  isClient: () => import_core48.isClient,
  isIndeterminate: () => isIndeterminate,
  isPresent: () => isPresent,
  isServer: () => import_core48.isServer,
  isServerSide: () => isServerSide,
  isTamaguiComponent: () => import_core48.isTamaguiComponent,
  isTamaguiElement: () => import_core48.isTamaguiElement,
  isTouchable: () => import_core48.isTouchable,
  isVariable: () => import_core48.isVariable,
  isWeb: () => import_core48.isWeb,
  isWebTouchable: () => import_core48.isWebTouchable,
  matchMedia: () => import_core48.matchMedia,
  mediaObjectToString: () => import_core48.mediaObjectToString,
  mediaQueryConfig: () => import_core48.mediaQueryConfig,
  mediaState: () => import_core48.mediaState,
  spacedChildren: () => import_core48.spacedChildren,
  styled: () => import_core48.styled,
  themeable: () => import_core48.themeable,
  ...
  useDidFinishSSR: () => import_core48.useDidFinishSSR,
  useEvent: () => import_core48.useEvent,
  useFloatingContext: () => useFloatingContext,
  useForceUpdate: () => useForceUpdate2,
  useFormContext: () => useFormContext,
  useGet: () => import_core48.useGet,
  useIsPresent: () => useIsPresent,
  useIsTouchDevice: () => import_core48.useIsTouchDevice,
  useIsomorphicLayoutEffect: () => import_core48.useIsomorphicLayoutEffect,
  useLabelContext: () => useLabelContext,
  useMedia: () => import_core48.useMedia,
  usePopoverScope: () => usePopoverScope,
  usePopperContext: () => usePopperContext,
  usePortal: () => usePortal,
  usePresence: () => usePresence,
  useSafeRef: () => import_core48.useSafeRef,
  useSelectContext: () => useSelectContext,
  useStyle: () => import_core48.useStyle,
  useTheme: () => import_core48.useTheme,
  useThemeName: () => import_core48.useThemeName,
  useWindowDimensions: () => useWindowDimensions2,
  variableToString: () => import_core48.variableToString,
  withStaticProperties: () => import_core48.withStaticProperties,
...
var ScrollView = (0, import_web4.styled)(import_react_native3.ScrollView, {
  name: "ScrollView",
  scrollEnabled: true,
  variants: {
    fullscreen: {
...
var SheetOverlayFrame = (0, import_core11.styled)(ThemeableStack, {
...
var SheetImplementation = (0, import_core11.themeable)(
  (0, import_react13.forwardRef)(/* @__PURE__ */ __name(function SheetImplementation2(props, forwardedRef) {
    ...
    const sheetRef = (0, import_react13.useRef)(null);
    ...
    const sizeBeforeKeyboard = (0, import_react13.useRef)(null);
    (0, import_react13.useEffect)(() => {
...
var DialogOverlayFrame = (0, import_core12.styled)(SheetOverlayFrame, {
  name: OVERLAY_NAME
});
...
var DialogContent = DialogContentFrame.extractable(
  React11.forwardRef(
    ({ __scopeDialog, ...props }, forwardedRef) => {
      ...
      if (!import_core12.isWeb || context.disableRemoveScroll) {
        return contents;
      }
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        RemoveScroll,
  ...
  React11.forwardRef(/* @__PURE__ */ __name(function Dialog2(props, ref) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(AdaptProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      DialogProvider,
      {
        ...
        disableRemoveScroll,
        children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogSheetController, { onOpenChange: setOpen, __scopeDialog, children })
      }
    ) });
  }, "Dialog2")),
  {
...
var ButtonTextFrame = (0, import_web10.styled)(SizableText, {
...
var ButtonTextComponent = ButtonTextFrame.extractable(
  (0, import_react15.forwardRef)(
    (props, ref) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(ButtonTextFrame, { size: props.size ?? context.size, ...props, ref });
    }
  )
);
...
var ButtonComponent = (0, import_react15.forwardRef)(
  /* @__PURE__ */ __name(function Button(props, ref) {
    ...
    const [buttonTextCount, setButtonTextCount] = (0, import_react15.useState)(0);
    const registerButtonText = (0, import_react15.useCallback)(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
      ButtonProvider,
      {
        ...
        registerButtonText,
        children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(ButtonFrame, { ...hasTextComponent ? props : buttonProps, ref })
      }
    );
  }, "Button")
);
...
var Button2 = (0, import_web10.withStaticProperties)(
...
var import_focusable2 = __toESM(require_cjs18());
...
var import_focusable = __toESM(require_cjs18());
...
var LabelComponent = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(LabelProvider, { id, controlRef, children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
      LabelFrame,
      {
        role: "heading",
        id,
...
var CheckboxIndicatorFrame = (0, import_core15.styled)(ThemeableStack, {
...
var CheckboxFrame = (0, import_core15.styled)(ThemeableStack, {
  name: CHECKBOX_NAME,
  tag: "button",
  variants: {
    unstyled: {
    ...
    size: {
      "...size": (val, { tokens: tokens2 }) => {
        const radiusToken = (0, import_core15.getVariableValue)((0, import_get_size.getSize)(val)) / 8;
        return {
          borderRadius: radiusToken
        };
      }
...
var Checkbox = (0, import_core15.withStaticProperties)(
  CheckboxFrame.extractable(
    React16.forwardRef(
      (props, forwardedRef) => {
        ...
        const composedRefs = (0, import_core15.useComposedRefs)(forwardedRef, (node) => setButton(node));
        const hasConsumerStoppedPropagationRef = React16.useRef(false);
        const propsActive = (0, import_core15.useMediaPropsActive)(props);
        const isFormControl = import_core15.isWeb ? button ? Boolean(button.closest("form")) : true : false;
        const [checked = false, setChecked] = useControllableState({
          prop: checkedProp,
          defaultProp: defaultChecked,
          onChange: onCheckedChange
        });
        const adjustedSize = (0, import_core15.getVariableValue)(
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
          CheckboxProvider,
          {
            ...
            size: size3,
            scaleIcon,
            children: import_core15.isWeb && native ? /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
              BubbleInput,
              {
                control: button,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
                CheckboxFrame,
                {
                  ...
                  ...import_core15.isWeb && {
                    type: "button",
                    value,
                    onKeyDown: (0, import_core15.composeEventHandlers)(
                      props.onKeyDown,
                      (event) => {
                        if (event.key === "Enter")
                          event.preventDefault();
                  ...
                  onPress: (0, import_core15.composeEventHandlers)(props.onPress, (event) => {
                    setChecked(
              ...
              import_core15.isWeb && isFormControl ? /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
                BubbleInput,
                {
                  isHidden: true,
                  control: button,
...
var FORM_NAME = "Form";
var FormFrame = (0, import_core16.styled)(import_core16.Stack, {
  name: FORM_NAME,
  tag: "form"
});
...
var FormTriggerFrame = (0, import_core16.styled)(import_core16.Stack, {
  name: TRIGGER_NAME3
});
    ...
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
        FormTriggerFrame,
        {
          ...
          ref: forwardedRef,
          onPress: (0, import_core16.composeEventHandlers)(props.onPress, context.onSubmit)
        }
      );
    }
  )
...
function FormComponent({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(FormProvider, { scope: props.__scopeForm, onSubmit, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(FormFrame, { ...props, onSubmit: (e) => e.preventDefault() }) });
}
__name(FormComponent, "FormComponent");
var Form = (0, import_core16.withStaticProperties)(FormFrame.extractable(FormComponent), {
  Trigger: FormTrigger
});

// node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports2, __toESM(require_cjs22(), 1));
...
var PopperAnchor = YStack.extractable(
  React18.forwardRef(/* @__PURE__ */ __name(function PopperAnchor2(props, forwardedRef) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(YStack, { ...getReferenceProps ? getReferenceProps(stackProps) : stackProps });
  }, "PopperAnchor2"))
);
var CONTENT_NAME3 = "PopperContent";
var PopperContentFrame = (0, import_core19.styled)(ThemeableStack, {
  name: "PopperContent",
  variants: {
    unstyled: {
      false: {
...
var PopperArrowFrame = (0, import_core19.styled)(YStack, {
  name: "PopperArrow",
  variants: {
    unstyled: {
      false: {
...
var PopperArrowOuterFrame = (0, import_core19.styled)(YStack, {
...
var PopperArrow = PopperArrowFrame.extractable(
  React18.forwardRef(/* @__PURE__ */ __name(function PopperArrow2(props, forwardedRef) {
    var _a, _b;
    const {
      __scopePopper,
      offset: offset2,
    ...
    const sizeValResolved = (0, import_core19.getVariableValue)((0, import_get_size2.stepTokenUpOrDown)("space", sizeVal, -2, [2]));
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(PopperArrowOuterFrame, { ref: refs, ...arrowStyle, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
      PopperArrowFrame,
      {
        width: size3,
        height: size3,
...
var PopoverAnchor = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(PopperAnchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
...
var PopoverTrigger = React20.forwardRef((props, forwardedRef) => {
  ...
  const trigger = /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
    YStack,
    {
      ...
      ...triggerProps,
      ref: composedTriggerRef,
      onPress: (0, import_core20.composeEventHandlers)(props.onPress, context.onOpenToggle)
    }
  );
  return context.hasCustomAnchor ? trigger : /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(PopperAnchor, { asChild: true, ...popperScope, children: trigger });
});
...
var PopoverContent = PopperContentFrame.extractable(
  React20.forwardRef(
    /* @__PURE__ */ __name(function PopoverContent2(props, forwardedRef) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(PopoverContentPortal, { zIndex: zIndex2, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
        PopoverContentImpl,
        {
          ...contentImplProps,
          disableRemoveScroll,
          ...
          disableOutsidePointerEvents: true,
          onCloseAutoFocus: (0, import_core20.composeEventHandlers)(props.onCloseAutoFocus, (event) => {
            var _a;
            event.preventDefault();
            if (!isRightClickOutsideRef.current)
              (_a = context.triggerRef.current) == null ? void 0 : _a.focus();
          }),
          onPointerDownOutside: (0, import_core20.composeEventHandlers)(
            props.onPointerDownOutside,
            (event) => {
              const originalEvent = event.detail.originalEvent;
              const ctrlLeftClick = originalEvent.button === 0 && originalEvent.ctrlKey === true;
          ...
          onFocusOutside: (0, import_core20.composeEventHandlers)(
            props.onFocusOutside,
            (event) => event.preventDefault(),
            { checkDefaultPrevented: false }
          )
...
function PopoverContentPortal(props) {
  const themeName = (0, import_core20.useThemeName)();
  const context = usePopoverInternalContext(CONTENT_NAME4, props.__scopePopover);
  let contents = props.children;
  if (import_react_native7.Platform.OS === "android") {
    const popperContext = usePopperContext(CONTENT_NAME4, context.popperScope);
    contents = /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(PopperProvider, { ...popperContext, scope: context.popperScope, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(PopoverProviderInternal, { scope: props.__scopePopover, ...context, children: props.children }) });
  }
  const zIndex2 = props.zIndex ?? 1e3;
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Portal, { zIndex: zIndex2, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(import_core20.Theme, { forceClassName: true, name: themeName, children: [
    !!context.open && !context.breakpointActive && /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
      YStack,
      {
        fullscreen: true,
        onPress: (0, import_core20.composeEventHandlers)(props.onPress, context.onOpenToggle)
    ...
    /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(import_core20.Stack, { zIndex: zIndex2 + 1, children: contents })
  ] }) });
}
...
var PopoverContentImpl = React20.forwardRef((props, forwardedRef) => {
  ...
  if (context.breakpointActive) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(PortalItem, { hostName: `${context.scopeKey}PopoverContents`, children: childrenWithoutScrollView });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(AnimatePresence, { children: !!context.open && /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
    PopperContent,
    {
      "data-state": getState3(context.open),
      id: context.contentId,
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
        RemoveScroll,
        {
          ...
          children: trapFocus === false ? children : /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
            import_focus_scope2.FocusScope,
            {
              ...
              onMountAutoFocus: onOpenAutoFocus,
              onUnmountAutoFocus: onCloseAutoFocus,
              children: import_core20.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { style: { display: "contents" }, children }) : children
            }
          )
        }
      )
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
      YStack,
      {
        ...closeProps,
        ref: forwardedRef,
        onPress: (0, import_core20.composeEventHandlers)(
          props.onPress,
          () => context.onOpenChange(false)
        )
      }
...
var PopoverArrow = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopoverScope(__scopePopover);
    return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(PopperArrow, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
PopoverArrow.displayName = ARROW_NAME2;
var PopoverScrollView = React20.forwardRef((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(import_react_native7.ScrollView, { ref, ...props });
});
var Popover = (0, import_core20.withStaticProperties)(
  /* @__PURE__ */ __name(function Popover2(props) {
    ...
    const { when, AdaptProvider } = useAdaptParent({
      Contents: React20.useCallback(() => {
        return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(PortalHost, { name: `${id}PopoverContents` });
      }, [])
    });
    ...
    const popoverContext = {
      ...
      breakpointActive,
      onOpenChange: setOpen,
      onOpenToggle: (0, import_core20.useEvent)(() => {
    ...
    const contents = /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Popper, { ...popperScope, stayInFrame: true, ...restProps, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(PopoverProviderInternal, { ...popoverContext, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(PopoverSheetController, { onOpenChange: setOpen, __scopePopover, children }) }) });
    return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(AdaptProvider, { children: import_core20.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(FloatingOverrideContext.Provider, { value: floatingContext, children: contents }) : contents });
  }, "Popover2"),
  {
...
var PopoverSheetController = /* @__PURE__ */ __name((props) => {
  ...
  const getShowSheet = (0, import_core20.useGet)(showSheet);
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
    SheetController,
    {
      onOpenChange: (val) => {
...
var useSheetBreakpointActive2 = /* @__PURE__ */ __name((breakpoint) => {
  const media2 = (0, import_core20.useMedia)();
...
var ProgressIndicatorFrame = (0, import_core21.styled)(ThemeableStack, {
...
var DEFAULT_MAX = 100;
var ProgressFrame = (0, import_core21.styled)(ThemeableStack, {
  name: PROGRESS_NAME,
  borderRadius: 1e5,
  overflow: "hidden",
  backgrounded: true,
  variants: {
    size: {
      "...size": (val) => {
        const size3 = Math.round((0, import_core21.getVariableValue)((0, import_get_size3.getSize)(val)) * 0.25);
        return {
          height: size3,
          minWidth: (0, import_core21.getVariableValue)(size3) * 20,
          width: "100%"
        };
      }
    }
...
var Progress = (0, import_core21.withStaticProperties)(
  ProgressFrame.extractable(
    React21.forwardRef(
      (props, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(ProgressProvider, { scope: __scopeProgress, value, max: max3, width, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
          ProgressFrame,
          {
            size: size3,
            "aria-valuemax": max3,
...
var import_focusable3 = __toESM(require_cjs18());
...
var RadioIndicatorFrame = (0, import_core22.styled)(ThemeableStack, {
...
var RadioGroupItemFrame = (0, import_core22.styled)(ThemeableStack, {
    ...
    size: {
      "...size": (value, { props }) => {
        const size3 = Math.floor(
          (0, import_core22.getVariableValue)((0, import_get_size4.getSize)(value)) * (props["scaleSize"] ?? 0.5)
        );
        return {
          width: size3,
          height: size3
...
var RadioGroupItem = RadioGroupItemFrame.extractable(
  React22.forwardRef(
    (props, forwardedRef) => {
      ...
      const composedRefs = (0, import_core22.useComposedRefs)(forwardedRef, (node) => setButton(node), ref);
      const isArrowKeyPressedRef = React22.useRef(false);
      const isFormControl = import_core22.isWeb ? button ? Boolean(button.closest("form")) : true : false;
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(RadioGroupItemProvider, { checked, scope: __scopeRadioGroup, children: import_core22.isWeb && native ? /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
        BubbleInput2,
        {
          control: button,
          bubbles: !hasConsumerStoppedPropagationRef.current,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
          RadioGroupItemFrame,
          {
            ...
            ...itemProps,
            onPress: (0, import_core22.composeEventHandlers)(props.onPress, (event) => {
              if (!checked) {
                onChange == null ? void 0 : onChange(value);
              }
              if (isFormControl) {
            ...
            ...import_core22.isWeb && {
              onKeyDown: (0, import_core22.composeEventHandlers)(
                props.onKeyDown,
                (event) => {
                  if (event.key === "Enter")
                    event.preventDefault();
              ...
              onFocus: (0, import_core22.composeEventHandlers)(itemProps.onFocus, () => {
                var _a;
...
var RadioGroupFrame = (0, import_core22.styled)(ThemeableStack, {
...
var RadioGroup = (0, import_core22.withStaticProperties)(
...
var Separator = (0, import_core23.styled)(import_core23.Stack, {
  name: "Separator",
  borderColor: "$borderColor",
  flexShrink: 0,
  borderWidth: 0,
  ...
  variants: {
    vertical: {
      true: {
        y: 0,
        x: -0.5,
        height: import_core23.isWeb ? "initial" : "auto",
        ...
        maxHeight: import_core23.isWeb ? "initial" : "auto",
        width: 0,
        maxWidth: 0,
        borderBottomWidth: 0,
        borderRightWidth: 1
...
var ForwardSelectContext = /* @__PURE__ */ __name((props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(SelectProvider, { isInSheet: true, scope: props.__scopeSelect, ...props.context, children: props.children });
...
var SelectContent = /* @__PURE__ */ __name(({
  ...
  const contents = /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_core25.Theme, { forceClassName: true, name: themeName, children });
  const touch = (0, import_core25.useIsTouchDevice)();
  if (showSheet) {
    if (!context.open) {
      return null;
    }
    return /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_jsx_runtime25.Fragment, { children: contents });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(FloatingPortal, { children: context.open ? /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(FloatingOverlay, { style: { zIndex: zIndex2 }, lockScroll: !touch, children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_focus_scope3.FocusScope, { loop: true, trapped: true, ...focusScopeProps, children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(Dismissable, { children: contents }) }) }) : /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { style: { display: "none" }, children: contents }) });
}, "SelectContent");
...
var SelectInlineImpl = /* @__PURE__ */ __name((props) => {
  ...
  const touch = (0, import_core26.useIsTouchDevice)();
  ...
  if (import_core26.isWeb && import_core26.isClient) {
    React23.useEffect(() => {
      if (!open)
        return;
...
var SelectViewportFrame = (0, import_core29.styled)(ThemeableStack, {
  name: VIEWPORT_NAME,
  backgroundColor: "$background",
  elevate: true,
  bordered: true,
...
var SelectViewport = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    const breakpointActive = useSelectBreakpointActive(context.sheetBreakpoint);
    if (breakpointActive || !import_core28.isWeb) {
      return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(PortalItem, { hostName: `${context.scopeKey}SheetContents`, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(ForwardSelectContext, { context, children }) });
    }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
      !disableScroll && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
        "style",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(FloatingFocusManager, { context: context.floatingContext, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
        SelectViewportFrame,
        {
          size: context.size,
          role: "presentation",
...
var SelectValueFrame = (0, import_core30.styled)(Paragraph, {
  name: VALUE_NAME,
  userSelect: "none"
});
...
var SelectIcon = (0, import_core30.styled)(XStack, {
  name: "SelectIcon",
  // @ts-ignore
  "aria-hidden": true,
  children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Paragraph, { children: "\u25BC" })
});
...
var SelectItemTextFrame = (0, import_core30.styled)(SizableText, {
  name: ITEM_TEXT_NAME,
  userSelect: "none"
});
var SelectItemText = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_jsx_runtime29.Fragment, { children: contents });
  }
);
SelectItemText.displayName = ITEM_TEXT_NAME;
var ITEM_INDICATOR_NAME = "SelectItemIndicator";
var SelectItemIndicatorFrame = (0, import_core30.styled)(XStack, {
  name: ITEM_TEXT_NAME
});
var SelectItemIndicator = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(SelectItemIndicatorFrame, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
SelectItemIndicator.displayName = ITEM_INDICATOR_NAME;
var GROUP_NAME = "SelectGroup";
var [SelectGroupContextProvider, useSelectGroupContext] = createSelectContext(GROUP_NAME);
var SelectGroupFrame = (0, import_core30.styled)(YStack, {
  name: GROUP_NAME,
  width: "100%"
});
var SelectGroup = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId || "", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
      SelectGroupFrame,
      {
        role: "group",
...
var SelectSeparator = (0, import_core30.styled)(Separator, {
...
var SelectSheetImpl = /* @__PURE__ */ __name((props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(import_jsx_runtime29.Fragment, { children: props.children });
}, "SelectSheetImpl");
  ...
  (props) => {
    ...
    const { when, AdaptProvider } = useAdaptParent({
      Contents: React26.useCallback(
        () => /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(PortalHost, { name: `${scopeKey}SheetContents` }),
        [scopeKey]
      )
    });
    const sheetBreakpoint = when;
    const isSheet = useSelectBreakpointActive(sheetBreakpoint);
    const SelectImpl = isSheet || !import_core30.isWeb ? SelectSheetImpl : SelectInlineImpl;
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(AdaptProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
      SelectProvider,
      {
        dir,
        ...
        value,
        open,
        children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(SelectSheetController, { onOpenChange: setOpen, __scopeSelect, children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
          SelectImpl,
          {
            activeIndexRef,
            listContentRef,
...
var DirectionalYStack = (0, import_core31.styled)(YStack, {
  variants: {
    orientation: {
      horizontal: {},
      vertical: {}
...
var SliderFrame = (0, import_core31.styled)(DirectionalYStack, {
  position: "relative",
  variants: {
    size: (val, extras) => {
      const orientation = extras.props.orientation;
      const size3 = Math.round((0, import_core31.getVariableValue)((0, import_get_size5.getSize)(val)) / 6);
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(
      SliderFrame,
      {
        ...
        onResponderGrant: (0, import_core31.composeEventHandlers)(props.onResponderGrant, (event) => {
          const target = event.target;
          const isStartingOnThumb = context.thumbs.has(target);
          if (import_core31.isWeb && target instanceof HTMLElement) {
        ...
        onResponderMove: (0, import_core31.composeEventHandlers)(props.onResponderMove, (event) => {
          event.stopPropagation();
          onSlideMove(event);
        }),
        onResponderRelease: (0, import_core31.composeEventHandlers)(props.onResponderRelease, (event) => {
          onSlideEnd(event);
        })
      }
    );
...
var SliderTrackFrame = (0, import_core32.styled)(SliderFrame, {
  name: "SliderTrack",
  height: "100%",
  width: "100%",
  backgroundColor: "$background",
...
var SliderTrackActiveFrame = (0, import_core32.styled)(SliderFrame, {
...
var SliderThumbFrame = (0, import_core32.styled)(ThemeableStack, {
  name: "SliderThumb",
  position: "absolute",
  bordered: 2,
  borderWidth: 2,
  backgrounded: true,
  pressTheme: import_core32.isWeb,
  focusTheme: import_core32.isWeb,
  hoverTheme: import_core32.isWeb,
  variants: {
    size: {
      "...size": getThumbSize
    }
...
var SliderThumb = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    const [size3, setSize] = React29.useState(() => {
      const estimatedSize = (0, import_core32.getVariableValue)(getThumbSize(sizeIn).width);
...
var Slider = (0, import_core32.withStaticProperties)(
...
var import_focusable4 = __toESM(require_cjs18());
var import_get_size7 = __toESM(require_cjs10());
var React30 = __toESM(require("react"));
var SWITCH_NAME = "Switch";
var getSwitchHeight = /* @__PURE__ */ __name((val) => Math.round((0, import_core33.getVariableValue)((0, import_get_size7.getSize)(val)) * 0.65), "getSwitchHeight");
...
var SwitchThumbFrame = (0, import_core33.styled)(ThemeableStack, {
  name: "SwitchThumb",
  variants: {
    unstyled: {
      false: {
    ...
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
        SwitchThumbFrame,
        {
          ...
          "data-disabled": disabled ? "" : void 0,
          ...thumbProps,
          x: checked ? (0, import_core33.getVariableValue)(getSwitchWidth(size3)) - (0, import_core33.getVariableValue)(getSwitchHeight(size3)) : 0,
          ref: forwardedRef
        }
      );
    }
...
var SwitchFrame = (0, import_core33.styled)(XStack, {
  name: SWITCH_NAME,
  tag: "button",
  variants: {
    unstyled: {
...
var Switch = (0, import_core33.withStaticProperties)(
  SwitchFrame.extractable(
    React30.forwardRef(
      (props, forwardedRef) => {
        ...
        const isFormControl = import_core33.isWeb ? button ? Boolean(button.closest("form")) : true : false;
        const [checked = false, setChecked] = useControllableState({
          prop: checkedProp,
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)(
          SwitchProvider,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
                SwitchFrame,
                {
                  ...
                  onPress: (event) => {
                    ...
                    if (import_core33.isWeb && isFormControl) {
                      hasConsumerStoppedPropagationRef.current = event.isPropagationStopped();
                      if (!hasConsumerStoppedPropagationRef.current)
                        event.stopPropagation();
                    }
              ...
              import_core33.isWeb && isFormControl && /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
                BubbleInput3,
                {
                  control: button,
                  bubbles: !hasConsumerStoppedPropagationRef.current,
...
var import_group = __toESM(require_cjs22());
...
function createCollection(name) {
  ...
  const CollectionSlot = import_react28.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(import_core34.Slot, { ref: composedRefs, children });
    }
  );
  ...
  const CollectionItemSlot = import_react28.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(import_core34.Slot, { ...{ [ITEM_DATA_ATTR]: "" }, ref: composedRefs, children });
    }
  );
...
var RovingFocusGroupImpl = React32.forwardRef((props, forwardedRef) => {
  ...
  const handleEntryFocus = (0, import_core35.useEvent)(onEntryFocus);
    ...
    RovingFocusProvider,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(
        import_core35.Stack,
        {
          ...
          onMouseDown: (0, import_core35.composeEventHandlers)(props.onMouseDown, () => {
            isClickFocusRef.current = true;
          }),
          onFocus: (0, import_core35.composeEventHandlers)(props.onFocus, (event) => {
          ...
          onBlur: (0, import_core35.composeEventHandlers)(
            props.onBlur,
    ...
    Collection.ItemSlot,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(
        import_core35.Stack,
        {
          ...
          ...itemProps,
          ref: forwardedRef,
          onMouseDown: (0, import_core35.composeEventHandlers)(props.onMouseDown, (event) => {
            if (!focusable)
              event.preventDefault();
            else
              context.onItemFocus(id);
          }),
          onFocus: (0, import_core35.composeEventHandlers)(props.onFocus, () => context.onItemFocus(id)),
          ...import_core35.isWeb && {
            onKeyDown: (0, import_core35.composeEventHandlers)(
              props.onKeyDown,
              (event) => {
...
var RovingFocusGroup = (0, import_core35.withStaticProperties)(
  React32.forwardRef(
    (props, forwardedRef) => {
      return /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(Collection.Provider, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(Collection.Slot, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
    }
  ),
  {
...
var TabsTrigger = TabsTriggerFrame.extractable(
  React33.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(import_web13.Theme, { name: isSelected ? "active" : null, children: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
...
var Toggle = ToggleFrame.extractable(
  React34.forwardRef((props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(import_web14.Theme, { name: pressed ? "active" : null, children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
      ToggleFrame,
      {
...
var ToggleGroupItem = ToggleFrame.extractable(
  import_react29.default.forwardRef(
    (props, forwardedRef) => {
      ...
      const childrens = import_react29.default.Children.toArray(props.children);
      const children = childrens.map((child) => {
        if (props.disablePassStyles || !import_react29.default.isValidElement(child)) {
          return child;
        }
        return getThemedIcon(child);
      });
      const commonProps = { ...props, pressed, disabled, ...sizeProps, children };
      return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToggleGroupItemProvider, { scope: __scopeToggleGroup, children: context.rovingFocus ? /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
        RovingFocusGroup.Item,
        {
          asChild: true,
          ...rovingFocusGroupScope,
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
            ToggleFrame,
            {
              ...
              ref,
              ...groupItemProps,
              children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
            }
          )
        }
      ) : /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToggleFrame, { asChild: true, focusable: !disabled, disabled, ref, children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef }) }) });
    }
  )
);
...
var ToggleGroup = (0, import_web15.withStaticProperties)(
  import_react29.default.forwardRef((props, forwardedRef) => {
    ...
    if (type === "single") {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
    }
    if (type === "multiple") {
      const multipleProps = toggleGroupProps;
      return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
    }
...
var ToggleGroupImplSingle = import_react29.default.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue: defaultValue2,
    onValueChange = /* @__PURE__ */ __name(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      onItemDeactivate: import_react29.default.useCallback(() => disableDeactivation ? null : setValue(""), [setValue, disableDeactivation]),
      children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = import_react29.default.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue: defaultValue2,
    onValueChange = /* @__PURE__ */ __name(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
    ...
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
        ToggleGroupContext,
        {
          ...
          disabled,
          size: size3,
          children: rovingFocus ? /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
            RovingFocusGroup,
            {
              asChild: true,
              ...rovingFocusGroupScope,
...
var TooltipArrow = React36.forwardRef((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(PopoverArrow, { componentName: "Tooltip", ref, ...props });
});
var TooltipGroup = /* @__PURE__ */ __name(({ children, delay }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(FloatingDelayGroup, { delay: React36.useMemo(() => delay, [JSON.stringify(delay)]), children });
}, "TooltipGroup");
var TooltipComponent = React36.forwardRef(/* @__PURE__ */ __name(function Tooltip(props, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(FloatingOverrideContext.Provider, { value: useFloatingContext2, children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(Popper, { size: size3, ...popperScope, ...restProps, children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(
...
var TooltipSimple = /* @__PURE__ */ __name(({
  ...
  const contents = /* @__PURE__ */ (0, import_jsx_runtime40.jsxs)(Tooltip2, { ...tooltipProps, children: [
    /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(Tooltip2.Trigger, { asChild: true, children }),
    /* @__PURE__ */ (0, import_jsx_runtime40.jsxs)(
      Tooltip2.Content,
      {
        ...
        ...contentProps,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(Tooltip2.Arrow, {}),
          /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(Paragraph, { size: "$2", lineHeight: "$0", children: label })
        ]
      }
    )
  ] });
  if (!context) {
    return /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(TooltipGroup, { delay: defaultTooltipDelay, children: contents });
  }
  return contents;
}, "TooltipSimple");
...
function useDebounce(fn, wait, options = defaultOpts, mountArgs = []) {
  const dbEffect = (0, import_react32.useRef)(null);
...
function useDebounceValue(val, amt = 0) {
  const [state, setState] = (0, import_react32.useState)(val);
  (0, import_react32.useEffect)(() => {
    const tm = setTimeout(() => {
      setState((prev) => {
        if (prev === val)
...
function useForceUpdate2() {
  return isServerSide ? idFn3 : (0, import_react33.useReducer)((x) => x + 1, 0)[1];
}
__name(useForceUpdate2, "useForceUpdate");

// node_modules/@tamagui/constants/dist/esm/index.mjs
var import_react34 = require("react");
var isWeb23 = process.env.TAMAGUI_TARGET === "web";
var isWindowDefined = typeof window !== "undefined";
var isServer = isWeb23 && !isWindowDefined;
var isClient4 = isWeb23 && isWindowDefined;
var isRSC2 = process.env.ENABLE_RSC;
var idFn4 = /* @__PURE__ */ __name(() => {
}, "idFn");
var useIsomorphicLayoutEffect12 = isRSC2 ? idFn4 : isServer ? import_react34.useEffect : import_react34.useLayoutEffect;
...
function useWindowDimensions2() {
  ...
  if (process.env.TAMAGUI_TARGET != "web")
    return current;
  const [state, setState] = (0, import_react35.useState)(initialValue);
...
var createTamagui = process.env.NODE_ENV !== "development" ? import_core37.createTamagui : (conf) => {
  const sizeTokenKeys = ["$true"];
  const hasKeys = /* @__PURE__ */ __name((expectedKeys, obj) => {
    return expectedKeys.every((k) => typeof obj[k] !== "undefined");
  }, "hasKeys");
  const tamaguiConfig = (0, import_core37.createTamagui)(conf);
...
var TamaguiProvider = import_core38.isRSC ? import_core38.TamaguiProvider : ({ children, ...props }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_core38.TamaguiProvider, { ...props, children: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(PortalProvider, { shouldAddRootHost: true, children }) });
};
...
var AnchorFrame = (0, import_core39.styled)(SizableText, {
  name: "Anchor",
  tag: "a",
  accessibilityRole: "link"
});
var Anchor = AnchorFrame.extractable(
  (0, import_react36.forwardRef)(({ href, target, ...props }, ref) => {
...
var EnsureFlexed = (0, import_core40.styled)(import_core40.Text, {
  opacity: 0,
  lineHeight: 0,
  height: 0,
  display: "flex",
...
var Fieldset = (0, import_core41.styled)(YStack, {
  name: "Fieldset",
  tag: "fieldset",
  variants: {
    horizontal: {
...
function Grid({ children, columns, itemMinWidth = 200, gap }) {
  ...
  const childrenList = import_react37.default.Children.toArray(children);
  return /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(XStack, { alignItems: "center", justifyContent: "center", flexWrap: "wrap", children: childrenList.map((child, i) => {
    if (!child) {
      return null;
    }
    return /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(
...
var import_focusable6 = __toESM(require_cjs18());
...
var inputSizeVariant = /* @__PURE__ */ __name((val = "$true", extras) => {
  ...
  if (!import_core43.isWeb && fontStyle) {
...
var textAreaSizeVariant = /* @__PURE__ */ __name((val = "$true", extras) => {
  ...
  const buttonStyles = (0, import_get_button_sized5.getButtonSized)(val, extras);
  const fontStyle = (0, import_get_font_sized3.getFontSized)(val, extras);
  const height = props.numberOfLines ? (props.numberOfLines || 1) * (0, import_core43.getVariableValue)(fontStyle.lineHeight) : "auto";
...
// node_modules/tamagui/dist/esm/views/Input.js
(0, import_core44.setupReactNative)({
...
var InputFrame = (0, import_core44.styled)(
...
var Section = (0, import_core45.styled)(import_core45.Stack, {
  name: "Section",
  tag: "section",
  flexDirection: "column",
  accessibilityRole: "summary"
});
var Article = (0, import_core45.styled)(import_core45.Stack, {
  name: "Article",
  tag: "article",
  flexDirection: "column"
});
var Main = (0, import_core45.styled)(import_core45.Stack, {
  name: "Main",
  tag: "main",
  flexDirection: "column"
});
var Header = (0, import_core45.styled)(import_core45.Stack, {
  name: "Header",
  tag: "header",
  accessibilityRole: "header",
  flexDirection: "column"
});
var Aside = (0, import_core45.styled)(import_core45.Stack, {
  name: "Aside",
  tag: "aside",
  flexDirection: "column"
  // accessibilityRole: 'complementary',
});
var Footer = (0, import_core45.styled)(import_core45.Stack, {
  name: "Footer",
  tag: "footer",
  flexDirection: "column"
  // accessibilityRole: 'contentinfo',
});
var Nav = (0, import_core45.styled)(import_core45.Stack, {
  name: "Nav",
  tag: "nav",
  flexDirection: "column"
...
var Spinner = YStack.extractable(
  (0, import_core46.themeable)(
    React38.forwardRef((props, ref) => {
      const { size: size3, color: colorProp, ...stackProps } = props;
      const theme = (0, import_core46.useTheme)();
      let color2 = colorProp;
      if (color2 && color2[0] === "$") {
        color2 = (0, import_core46.variableToString)(theme[color2]);
      }
      return /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(YStack, { ref, ...stackProps, children: /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(import_react_native11.ActivityIndicator, { size: size3, color: color2 }) });
    }),
    {
...
var import_focusable7 = __toESM(require_cjs18());
var TextAreaFrame = (0, import_core47.styled)(InputFrame, {
  name: "TextArea",
  multiline: true,
  variants: {
    unstyled: {
