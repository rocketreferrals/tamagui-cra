...
var require_cjs5 = __commonJS({
  "node_modules/@tamagui/get-size/dist/cjs/index.js"(exports, module2) {
    ...
    var stepTokenUpOrDown6 = /* @__PURE__ */ __name((type, name = "$true", shift2 = 0, bounds = [0]) => {
      const tokens = (0, import_core49.getTokens)({ prefixed: true })[type];
      const maybeTokenizedKeysOrdered = import_core49.tokensKeysOrdered.get(tokens) || Object.keys(tokens);
...
var require_getSpace = __commonJS({
  "node_modules/@tamagui/helpers-tamagui/dist/cjs/getSpace.js"(exports, module2) {
    ...
    var getSpace = /* @__PURE__ */ __name((token, sizeUpOrDownBy = 0) => {
      const spaces = (0, import_core49.getTokens)().space;
...
var require_getElevation = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/getElevation.js"(exports, module2) {
    ...
    var getElevation2 = /* @__PURE__ */ __name((size2, extras) => {
      ...
      const sizeNum = (0, import_core49.isVariable)(token) ? +token.val : size2;
      return getSizedElevation2(sizeNum, extras);
    }, "getElevation");
    var getSizedElevation2 = /* @__PURE__ */ __name((val, { theme, tokens }) => {
      let num = 0;
      if (val === true) {
        const val2 = (0, import_core49.getVariableValue)(tokens.size["true"]);
...
var require_Group = __commonJS({
  "node_modules/@tamagui/group/dist/cjs/Group.js"(exports, module2) {
    ...
    var import_jsx_runtime45 = require("react/jsx-runtime");
    var import_core49 = require("@tamagui/core-node");
    var import_create_context20 = require_cjs14();
    var import_stacks26 = require_cjs15();
    var import_use_controllable_state14 = require_cjs16();
    ...
    function createGroup(verticalDefault) {
      return (0, import_core49.withStaticProperties)(
        (0, import_react38.forwardRef)((props, ref) => {
          ...
          const radius = borderRadius ?? (size2 ? (0, import_core49.getVariableValue)((0, import_core49.getTokens)().radius[size2]) - 1 : void 0);
...
var require_ListItem = __commonJS({
  "node_modules/@tamagui/list-item/dist/cjs/ListItem.js"(exports, module2) {
    ...
    var import_helpers_tamagui4 = require_cjs12();
    var import_stacks26 = require_cjs15();
        ...
        props: {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [
            ...
            title || subTitle ? /* @__PURE__ */ (0, import_jsx_runtime45.jsxs)(import_stacks26.YStack, { flex: 1, children: [
              noTextWrap === "all" ? title : /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(Title, { size: size2, children: title }),
...
var require_addTheme = __commonJS({
  "node_modules/@tamagui/theme/dist/cjs/addTheme.js"(exports, module2) {
    ...
    var import_constants10 = require_cjs20();
    var import_web15 = require("@tamagui/core-node");
...
var ScrollView = (0, import_web2.styled)(import_react_native3.ScrollView, {
  name: "ScrollView",
  scrollEnabled: true,
  variants: {
    fullscreen: {
...
var Button2 = (0, import_web8.withStaticProperties)(
...
var import_focusable2 = __toESM(require_cjs13());
...
var import_focusable = __toESM(require_cjs13());
...
// node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports2, __toESM(require_cjs17(), 1), module.exports);
...
var PopoverContent = PopperContentFrame.extractable(
  React20.forwardRef(
    /* @__PURE__ */ __name(function PopoverContent2(props, forwardedRef) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(PopoverContentPortal, { zIndex, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
        PopoverContentImpl,
        {
          ...contentImplProps,
          disableRemoveScroll,
...
function PopoverContentPortal(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Portal, { zIndex, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(import_core20.Theme, { forceClassName: true, name: themeName, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(import_core20.Stack, { zIndex: zIndex + 1, children: contents })
  ] }) });
}
...
var useSheetBreakpointActive2 = /* @__PURE__ */ __name((breakpoint) => {
  const media = (0, import_core20.useMedia)();
...
var ProgressFrame = (0, import_core21.styled)(ThemeableStack, {
  ...
  variants: {
    size: {
      "...size": (val) => {
        const size2 = Math.round((0, import_core21.getVariableValue)((0, import_get_size3.getSize)(val)) * 0.25);
        return {
          height: size2,
          minWidth: (0, import_core21.getVariableValue)(size2) * 20,
          width: "100%"
        };
      }
    }
...
var import_focusable3 = __toESM(require_cjs13());
...
var SelectContent = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(FloatingPortal, { children: context.open ? /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(FloatingOverlay, { style: { zIndex }, lockScroll: !touch, children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_focus_scope3.FocusScope, { loop: true, trapped: true, ...focusScopeProps, children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(Dismissable, { children: contents }) }) }) : /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { style: { display: "none" }, children: contents }) });
}, "SelectContent");
...
var SliderFrame = (0, import_core31.styled)(DirectionalYStack, {
  ...
  variants: {
    size: (val, extras) => {
      ...
      const size2 = Math.round((0, import_core31.getVariableValue)((0, import_get_size5.getSize)(val)) / 6);
...
var import_focusable4 = __toESM(require_cjs13());
    ...
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(
        SwitchThumbFrame,
        {
          ...
          "data-disabled": disabled ? "" : void 0,
          ...thumbProps,
          x: checked ? (0, import_core33.getVariableValue)(getSwitchWidth(size2)) - (0, import_core33.getVariableValue)(getSwitchHeight(size2)) : 0,
          ref: forwardedRef
        }
      );
    }
...
var import_group = __toESM(require_cjs17());
...
var TabsTrigger = TabsTriggerFrame.extractable(
  React33.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(import_web11.Theme, { name: isSelected ? "active" : null, children: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
...
var Toggle = ToggleFrame.extractable(
  React34.forwardRef((props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(import_web12.Theme, { name: pressed ? "active" : null, children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(
      ToggleFrame,
      {
...
var TooltipComponent = React36.forwardRef(/* @__PURE__ */ __name(function Tooltip(props, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(FloatingOverrideContext.Provider, { value: useFloatingContext2, children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(Popper, { size: size2, ...popperScope, ...restProps, children: /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(
...
var import_focusable6 = __toESM(require_cjs13());
...
var Spinner = YStack.extractable(
  (0, import_core46.themeable)(
    React38.forwardRef((props, ref) => {
      ...
      let color = colorProp;
      if (color && color[0] === "$") {
        color = (0, import_core46.variableToString)(theme[color]);
      }
      return /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(YStack, { ref, ...stackProps, children: /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(import_react_native11.ActivityIndicator, { size: size2, color }) });
    }),
    {
...
var import_focusable7 = __toESM(require_cjs13());
